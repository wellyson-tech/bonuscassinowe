...
const App: React.FC = () => {
  ...
  // PÁGINA EXCLUSIVA DA ROLETA (#/roleta) - 100% INDEPENDENTE
  if (view === 'roleta') {
    return (
      <div className="min-h-screen bg-black text-white font-sans relative flex flex-col items-center overflow-x-hidden">
        <div className="fixed inset-0 bg-black -z-20" />
        <div className="fixed top-0 inset-x-0 h-[80vh] bg-gradient-to-b from-purple-900/10 via-black to-black -z-10 pointer-events-none" />
        
        <main className="relative z-10 w-full max-w-lg px-6 py-20 flex flex-col items-center">
          <header className="text-center mb-16 animate-fade-in">
            <div className="mb-4 flex justify-center">
               <span className="px-4 py-1.5 rounded-full border border-purple-500/30 bg-purple-500/10 text-purple-500 text-[9px] font-black uppercase tracking-[0.4em]">Acesso VIP Liberado</span>
            </div>
            <h1 className="text-5xl font-black uppercase tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white to-purple-400 italic mb-4">
              SALA ROLETA
            </h1>
            <p className="text-[10px] text-gray-500 uppercase font-bold tracking-[0.2em]">Estratégias e Multiplicadores Exclusivos</p>
          </header>
          ...
          <div className="w-full space-y-5">
            ...
            {filteredLinks.length === 0 && (
               <div className="py-20 text-center opacity-20 text-[10px] uppercase font-black">Nenhuma sala ativa</div>
            )}
          </div>
          ...
          <footer className="mt-24 opacity-30">
             <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-[8px] font-black uppercase tracking-[0.5em]">Servidores Seguros</p>
             </div>
          </footer>
        </main>
      </div>
